...
TEST(MumpsBLR_test, split_analyze_factorize) {
    ...
    Eigen::loadMarket(A, "../data/matrix_BLR.mtx");
...
TEST(MumpsBLR_test, base_flags) {
    MumpsBLR<SparseMatrix<double>> solver(NoDeterminant);
    ...
    MumpsBLR<SparseMatrix<double>> solver2(Verbose);
    ...
    MumpsBLR<SparseMatrix<double>> solver3(WorkingHost);
    ...
    MumpsBLR<SparseMatrix<double>> solver4(NoDeterminant | Verbose | WorkingHost);
    ...
    MumpsBLR<SparseMatrix<double>> solver5(NoDeterminant | Verbose);
    ...
    MumpsBLR<SparseMatrix<double>> solver6(NoDeterminant | WorkingHost);
    ...
    MumpsBLR<SparseMatrix<double>> solver7(Verbose | WorkingHost);
...
TEST(MumpsBLR_test, colmajor_vs_rowmajor) {
    ...
    Eigen::loadMarket(A_colmajor, "../data/matrix_BLR.mtx");
    Eigen::loadMarket(A_rowmajor, "../data/matrix_BLR.mtx");
...
TEST(Mumps_BLR, blr_flags) {
    ...
    MumpsBLR<SparseMatrix<double>> solver1(UCFS);
    ...
    MumpsBLR<SparseMatrix<double>> solver2(Compressed);
    ...
    MumpsBLR<SparseMatrix<double>> solver3(UCFS | Compressed);
    ...
    MumpsBLR<SparseMatrix<double>> solver4(0.5);
    ...
    MumpsBLR<SparseMatrix<double>> solver5(UCFS, 0.5);
    ...
    MumpsBLR<SparseMatrix<double>> solver6(Compressed, 0.5);
    ...
    MumpsBLR<SparseMatrix<double>> solver7(UCFS | Compressed, 0.5);
