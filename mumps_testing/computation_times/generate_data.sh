...
if [ "$MEMCHECK" = true ]; then
    valgrind --leak-check=full --track-origins=yes mpirun --use-hwthread-cpus ./mumps_computation_times

else
    mpirun --use-hwthread-cpus ./mumps_computation_times

fi
rm mumps_computation_times
